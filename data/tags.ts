...
const tags = [
  {
    ...
    description: "How you think, feel, and show up as a human doing complex work.",
    tags: [
      "Mindset",
      "Values",
      "Mental Health",
  ...
  },
  {
    ...
    tags: ["Productivity", "Time Management", "Communication", "Collaboration", "Accountability"],
  },
  {
    name: "Career",
    category: "Soft Skills",
    description: "How you grow influence, direction, and opportunity beyond your current role.",
    tags: [
      "Leadership",
      "Management",
      "Culture",
  ...
  },
  {
    ...
    category: "Software Engineering",
    description: "Building user-facing applications, APIs, and web platforms across modern stacks.",
    tags: [
      "Web Development",
      "JavaScript",
      "Node",
  ...
  },
  {
    ...
    category: "Software Engineering",
    description: "Programming languages and ecosystems used to build and run software.",
    tags: ["Clojure", "ClojureScript", "Java", "npm", "Webpack", "deps.edn", "Reagent"],
  },
  {
  ...
  },
  {
    ...
    category: "Software Engineering",
    description: "Hosting, deployment, networking, and platform services that software runs on.",
    tags: [
      "GCP",
      "Google Firebase",
  ...
  },
  {
    ...
    category: "Software Engineering",
    description: "Operating systems and environments developers work within day-to-day.",
    tags: ["Linux", "Fedora", "MacOS", "Terminal", "CLI", "Clojure CLI", "Telnet", "Hardware"],
  },
  {
    name: "Version Control and Collaboration",
    category: "Engineering Toolkit",
    description: "Managing code history, collaboration, and safe change over time.",
    tags: ["Git"],
  },
  {
    name: "Security",
    category: "Software Engineering",
    description: "Protecting systems, data, and users through secure design and tooling.",
    tags: ["Security", "Cisco"],
  },
  {
