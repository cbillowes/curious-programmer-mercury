...
resume:
  ...
  tech:
    ...
    - Firebase
    - Netlify
  summary: I designed and built a centralized event registration platform with Next.js, integrating Firebase for secure authentication and data management. By implementing a user-friendly Shadcn and TailwindCSS interface, I streamlined RSVP handling, reduced errors, and delivered a seamless guest experience.
---
