      ...
      <Container>
        ...
        <div id="article" className="max-w-3xl mx-auto px-4">
          ...
          <p>
            ...
            <Link href="https://utteranc.es ">https://utteranc.es</Link>.
            Utterances does not collect any personal information, does not log,
            write or retain any data, sets a cookie to store the github api
          ...
          <ul>
            ...
            <li>
              <Link href="https://www.algolia.com/policies/privacy/">
                Algolia
              </Link>
            </li>
            <li>
